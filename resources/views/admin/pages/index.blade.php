    ...
    <div class="card">
      <div class="position-relative">
        <figure class="overflow-hidden mb-0 d-flex justify-content-center">
          <img src="{{ asset('../../../backend/assets/images/pbg.jpg') }}" class="rounded-top" alt="کاور پروفایل" style="width: 100%; height: 200px">
        </figure>
        <div class="d-flex justify-content-between align-items-center position-absolute top-90 w-100 px-2 px-md-4 mt-n4">
          <div class="d-flex align-items-center">
            <img class="wd-70 rounded-circle" src="{{ asset($admin->photo) }}" alt="پروفایل">
            <span class="h4 ms-3 text-light">{{ $admin->username }}</span>
          </div>
          <div  class="d-none d-md-block">
            <a class="btn btn-primary btn-icon-text" href="{{ route('admin.edit.profile') }}">
      ...
      <div class="d-flex justify-content-center p-3 rounded-bottom">
        <ul class="d-flex align-items-center m-0 p-0">
          <li class="d-flex align-items-center active">
            ...
            <a class="pt-1px d-none d-md-block text-primary" href="#">تایم‌لاین</a>
          </li>
          <li class="ms-3 ps-3 border-start d-flex align-items-center">
            ...
            <a class="pt-1px d-none d-md-block text-body" href="#">درباره من</a>
          </li>
          <li class="ms-3 ps-3 border-start d-flex align-items-center">
            ...
            <a class="pt-1px d-none d-md-block text-body" href="#">دوستان <span class="text-muted tx-12">3,765</span></a>
          </li>
          <li class="ms-3 ps-3 border-start d-flex align-items-center">
            ...
            <a class="pt-1px d-none d-md-block text-body" href="#">عکس‌ها</a>
          </li>
          <li class="ms-3 ps-3 border-start d-flex align-items-center">
            ...
            <a class="pt-1px d-none d-md-block text-body" href="#">ویدئوها</a>
          </li>
        </ul>
      </div>
    </div>
