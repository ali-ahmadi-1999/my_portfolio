			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                   ...
                   <h5 class="text-muted fw-normal mb-4"> بازیابی رمز عبور </h5>
                   ...
                   @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('password.email') }}" class="forms-sample">
                         @csrf
                      <div class="mb-3">
                        <label for="userEmail" class="form-label"> ایمیل خود را وارد کنید   </label>
                     ...
                     <a href="{{ route('login') }}" class="d-block mt-3 text-muted" style="text-decoration: underline;"> صفحه ورود  </a>
